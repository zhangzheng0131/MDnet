...
switch(dataset)
    case {'otb'}
        % path to OTB dataset
        benchmarkSeqHome ='/home/zhangzheng/workplace/master/nntrackerpapers/matlab/MDNet-master/MDNet-master/dataset/OTB/';
    ...
    case {'vot2013','vot2014','vot2015'}
        % path to VOT dataset
        benchmarkSeqHome = ['/home/zhangzheng/workplace/master/nntrackerpapers/matlab/MDNet-master/MDNet-master/dataset/VOT/', dataset(end-3:end)];
